    ...
    <div id="templatemo_header_wh">
        <div id="templatemo_header" class="header_home">
            ...
            <div id="templatemo_menu" class="ddsmoothmenu">
                <ul>
                    <li><a href="main.jsp" class="selected">主页</a></li>
        ...
        <div id="templatemo_main">
            ...
            <div id="content" class="right">
                ...
                <div class="product_box">
                    <a href="/GetOneServlet?fid=${f.flowerid}"><img src="${f.pic}" alt="鲜花图片" style="width: 150px;height: 150px" /></a>
                    <h3>${f.flowername}</h3>
                    <p class="product_price">${f.price}</p>
                    <p class="add_to_cart">
                        <a href="/GetOneServlet?fid=${f.flowerid}">${f.show}</a>
                        <a href="/GetOneServlet?fid=${f.flowerid}">添加至购物车</a>
                    </p>
                </div>
                </c:forEach>
                <div>
                    <c:if test="${page>1}">
                        <a href="MainServlet?page=${up}">上一页</a>
                    </c:if>
                    <c:if test="${page<total}">
                        <a href="MainServlet?page=${next}">下一页</a>
                    </c:if>
                </div>
                <div class="blank_box">
