        ...
        <div id="templatemo_main">
            ...
            <div id="content" class="right">
                ...
                <div class="content_half left form_field">
                    <p>姓名</p>
                    <input name="fullname" type="text" id="fullname"value="${tuser.username}" maxlength="40" />
                    <p>地址</p>
                    <input name="address" type="text" id="address" value="${address.address}" maxlength="40" />
                    <p>城市</p>
                    <input name="city" type="text" id="city"value="${address.city}" maxlength="40" />
                    <p>国家</p>
                    <input name="country" type="text" id="country"value="${address.country}" maxlength="40" />
                </div>

                <div class="content_half right form_field">
                    <p>电子邮件</p>
                    <input name="email" type="text" id="email"value="${tuser.email}" maxlength="40" />
                    <p>电话:</p>
                    <input name="phone" type="text" id="phone"value="${tuser.phone}" maxlength="40" />
                    <span>指定您的可达电话号码，以便打电话给您进行验证。</span>
                    <p>点击下方修改地址</p>
                    <a href="alteradress.jsp">管理地址</a>
                </div>
