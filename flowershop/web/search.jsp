        ...
        <div id="templatemo_main">
            ...
            <div id="content" class="right">
                ...
                <div class="product_box">
                    <a href="/GetOneServlet?fid=${flower.flowerid}"><img src="${flower.pic}" alt="鲜花图片" style="width: 150px;height: 150px" /></a>
                    <h3>${flower.flowername}</h3>
                    <p class="product_price">${flower.price}</p>
                    <p class="add_to_cart">
                        <a href="/GetOneServlet?fid=${flower.flowerid}">${flower.show}</a>
                        <a href="/GetOneServlet?fid=${flower.flowerid}">添加至购物车</a>
                    </p>
                </div>
